package com.fredvatnsdal.survivalgame.GameObjects.Entities.Enemies.Ranged;
...
public class SkeletonArcher extends Enemy {
    public SkeletonArcher(float x, float y, float width, float height, GameWorld gameWorld, float scale) {
